...
open class GameProtocol(direction: PacketDirection, direction2: PacketDirection) : SimpleProtocol() {
    init {
        ...
        registerPacket(direction, 0x0C, PlayerGroundPacket, PlayerGround::class)
        registerPacket(direction, 0x0D, PlayerPositionPacket, PlayerPosition::class)
        registerPacket(direction, 0x0E, ClientPlayerPositionLookPacket, ClientPlayerPositionLook::class)
        registerPacket(direction, 0x0F, PlayerLookPacket, PlayerLook::class)
        ...
        registerPacket(direction, 0x1C, SignUpdatePacket, SignUpdate::class)
